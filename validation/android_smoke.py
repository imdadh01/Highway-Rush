...
def screen():
 ...
 return subprocess.check_output(['tesseract','test-screen.png','stdout','--psm','11','tsv'],text=True,stderr=subprocess.DEVNULL)
...
assert_text('Bakra Hisab');tap('Naya season');tap('Season ka naam',35);adb('shell','input','text','Android-test');time.sleep(1);adb('shell','input','keyevent','4');time.sleep(1);tap('Preview');tap('Confirm aur save');assert_text('Android-test')
